...
CREATE USER  IF NOT EXISTS 'wackopicko'@'%' IDENTIFIED BY 'webvuln!@#';
...
ALTER USER 'wackopicko'@'%' IDENTIFIED BY 'webvuln!@#' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0 ;
